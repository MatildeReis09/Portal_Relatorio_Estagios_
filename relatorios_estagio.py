...
URL_CSV_Respostas = "https://docs.google.com/spreadsheets/d/e/2PACX-1vSy4HVfG-ckMI2a0LHV17mq_HWnv5qwOj4R7yhcp7w_srg604hAWBSn6SrebKKI-cqrHKCcEwDo8jjA/pub?output=csv"
...
if acesso_autorizado:
    ...
    if coluna_data in df_resp.columns:
            ...
            df_resp[coluna_data] = pd.to_datetime(df_resp[coluna_data], dayfirst=True)
            ...
            with tab_semanal : 
                ...
                semana_disposicao = df_resp[df_resp['Nome'] == nome_utilizador] ['Semana de Referência'].unique() 
                ...
                if len (semana_disposicao) > 0 : 
                    ...
                    dados_semanais = df_resp[(df_resp['Nome'] == nome_utilizador) & (df_resp['Semana de Referência'] == semana_sel)]
            ...
            with tab_mensal:
                ...
                dados_mes = df_resp[(df_resp['Nome'] == nome_utilizador) & (df_resp['Carimbo de data/hora'].dt.month == mes_sel)]
